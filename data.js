...
const Oficina = {
  get() {
    try { return JSON.parse(localStorage.getItem('of_oficina')) || {}; }
    catch { return {}; }
  },
...
function seedDemoData() {
  ...
  // ---- ORDENS DE SERVIÇO (faturamento ~R$ 40.000 no mês atual) ----
  // Total calculado: ~R$ 40.200
  const os = [
    // Semana 1 (dias 0-6) — ~R$ 10.800
    { c:c1.id,  v:v1.id,  prob:'Revisão completa 45.000 km',          serv:'Troca de óleo, filtros, velas, correia',    pecas:'Óleo 5W30, Filtro ar/óleo, Velas NGK, Correia Gates', mo:'480', p:'620', st:'finalizado', d:d(0) },
    ...
    { c:c6.id,  v:v6.id,  prob:'Revisão 30.000 km',                   serv:'Revisão geral + troca de óleo',             pecas:'Óleo 0W20, Filtros, Velas',                           mo:'450', p:'480', st:'finalizado', d:d(0) },
    ...
    { c:c7.id,  v:v8.id,  prob:'Freios dianteiros gastos',            serv:'Troca de discos e pastilhas dianteiros',    pecas:'Discos Fremax, Pastilhas Bosch',                      mo:'320', p:'560', st:'finalizado', d:d(1) },
    ...
    { c:c4.id,  v:v4.id,  prob:'Troca de óleo sintético',             serv:'Troca de óleo 0W20 + filtro',               pecas:'Óleo 0W20 Toyota, Filtro original',                   mo:'160', p:'180', st:'finalizado', d:d(2) },
    { c:c15.id, v:v17.id, prob:'Motor com ruído ao acelerar',         serv:'Diagnóstico + troca de correia acessórios', pecas:'Correia acessórios, tensor',                          mo:'520', p:'380', st:'finalizado', d:d(2) },
    { c:c11.id, v:v12.id, prob:'Revisão 15.000 km',                   serv:'Revisão de garantia + troca de óleo',       pecas:'Óleo 5W30, Filtro',                                   mo:'200', p:'160', st:'finalizado', d:d(3) },
    { c:c5.id,  v:v20.id, prob:'Troca de pastilhas dianteiras',       serv:'Troca de pastilhas + sangria de freios',    pecas:'Pastilhas Bosch, Fluido DOT4',                        mo:'250', p:'220', st:'finalizado', d:d(3) },
    { c:c13.id, v:v15.id, prob:'Revisão Ranger 50.000 km',            serv:'Revisão completa + troca de óleo diesel',   pecas:'Óleo 5W40 diesel, Filtros, Velas',                    mo:'580', p:'620', st:'finalizado', d:d(3) },
    ...
    { c:c10.id, v:v11.id, prob:'Troca de óleo',                       serv:'Troca de óleo e filtro',                    pecas:'Óleo 5W30, Filtro',                                   mo:'150', p:'120', st:'finalizado', d:d(8) },
    ...
    { c:c9.id,  v:v10.id, prob:'Troca de óleo',                       serv:'Troca de óleo sintético',                   pecas:'Óleo 5W30, Filtro',                                   mo:'160', p:'140', st:'finalizado', d:d(10) },
    ...
    { c:c11.id, v:v12.id, prob:'Alinhamento e balanceamento',         serv:'Alinhamento 4 rodas + balanceamento',       pecas:'-',                                                   mo:'220', p:'0',   st:'finalizado', d:d(11) },
    { c:c15.id, v:v17.id, prob:'Troca de óleo',                       serv:'Troca de óleo + filtro',                    pecas:'Óleo 5W30, Filtro',                                   mo:'160', p:'140', st:'finalizado', d:d(12) },
    ...
    { c:c3.id,  v:v19.id, prob:'Revisão 10.000 km Polo',              serv:'Revisão de garantia',                       pecas:'Óleo 5W30, Filtro',                                   mo:'180', p:'150', st:'finalizado', d:d(15) },
    { c:c8.id,  v:v9.id,  prob:'Alinhamento e balanceamento',         serv:'Alinhamento + balanceamento',               pecas:'-',                                                   mo:'180', p:'0',   st:'finalizado', d:d(15) },
    ...
    { c:c1.id,  v:v1.id,  prob:'Troca de óleo',                       serv:'Troca de óleo + filtro',                    pecas:'Óleo 5W30, Filtro',                                   mo:'150', p:'110', st:'finalizado', d:d(16) },
    ...
    { c:c12.id, v:v13.id, prob:'Troca de óleo diesel S10',            serv:'Troca de óleo + filtros',                   pecas:'Óleo 5W40 diesel, Filtros',                           mo:'240', p:'220', st:'finalizado', d:d(17) },
    ...
    { c:c2.id,  v:v2.id,  prob:'Troca de óleo',                       serv:'Troca de óleo',                             pecas:'Óleo 5W30, Filtro',                                   mo:'150', p:'110', st:'finalizado', d:d(18) },
    { c:c7.id,  v:v8.id,  prob:'Troca de óleo Renegade',              serv:'Troca de óleo + filtro',                    pecas:'Óleo 0W20, Filtro',                                   mo:'170', p:'160', st:'finalizado', d:d(19) },
    ...
    { c:c11.id, v:v12.id, prob:'Troca de óleo T-Cross',               serv:'Troca de óleo + filtro',                    pecas:'Óleo 5W30, Filtro',                                   mo:'160', p:'140', st:'finalizado', d:d(21) },
    ...
    { c:c4.id,  v:v4.id,  prob:'Alinhamento e balanceamento',         serv:'Alinhamento 4 rodas + balanceamento',       pecas:'-',                                                   mo:'220', p:'0',   st:'finalizado', d:d(22) },
    ...
    { c:c3.id,  v:v3.id,  prob:'Troca de óleo Strada',                serv:'Troca de óleo + filtro',                    pecas:'Óleo 5W30, Filtro',                                   mo:'150', p:'110', st:'finalizado', d:d(23) },
    { c:c10.id, v:v11.id, prob:'Revisão 25.000 km Pulse',             serv:'Revisão + troca de óleo',                   pecas:'Óleo 5W30, Filtros, Velas',                           mo:'360', p:'320', st:'finalizado', d:d(24) },
    { c:c8.id,  v:v9.id,  prob:'Troca de óleo Kwid',                  serv:'Troca de óleo + filtro',                    pecas:'Óleo 5W30, Filtro',                                   mo:'140', p:'100', st:'finalizado', d:d(24) },
    { c:c14.id, v:v16.id, prob:'Troca de óleo HR-V',                  serv:'Troca de óleo + filtro',                    pecas:'Óleo 0W20, Filtro',                                   mo:'160', p:'150', st:'finalizado', d:d(25) },
  ...
  os.forEach(o => Ordens.save({
    clienteId: o.c, veiculoId: o.v, problema: o.prob,
    servicos: o.serv, pecas: o.pecas,
    valorMO: o.mo, valorPecas: o.p,
    status: o.st, data: o.d
  }));
  ...
  Lembretes.save({ veiculoId: v14.id, tipo: 'oleo',   descricao: 'Troca de óleo diesel — Hilux',       dataPrevisao: '2026-05-10', kmPrevisao: '85000' });
  Lembretes.save({ veiculoId: v15.id, tipo: 'revisao',descricao: 'Revisão 60.000 km — Ranger',         dataPrevisao: '2026-07-01', kmPrevisao: '60000' });
